...
<script src="addInput.js" language="Javascript" type="text/javascript"></script>
     <div id="dynamicInput"><b>
          Promotion</b><font size="1"> ie: Live Jazz, $2 appetizers, $1 drafts, $35 prixe fix menu, Ladies night etc. </font><br><input type="text" size='40' name="myInputs[]"><br>
...
Sunday<input type="hidden" name="days[7]" value="NULL"><input type="checkbox" name="days[7]" value="Sunday">
<br>
  <br></div>
