...
function validateRemove(){
	input_box=confirm("Are you sure you want to remove this event?");
if (input_box==true)
{ 
...
<html>
<title>DoGo Deals Remove Events Page</title>
<body>
 ...
 */
 if($session->logged_in){
   ...
   echo "Welcome <b>$session->username</b>, you are logged in. <br><br>"
       ...
       ."[<a href=\"add_rest_events.php\">Add Restaurant and Event info</a>] &nbsp;&nbsp;"
        ."[<a href=\"main.php\">Main Venue/Event Page</a>] &nbsp;&nbsp;"
...
while($row = mysql_fetch_array($results))
 ...
 <form action="process.php" method="POST" onSubmit="return validateRemove();">
...
<input type="hidden" name="subremoveEvent" value="500">
<td align="center" valign="bottom"><input type="submit" value="Remove Event"></td>
</form></table></td><td>
