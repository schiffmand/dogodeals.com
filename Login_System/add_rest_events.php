	...
	<div id="mainForm">
		...
		<form method=post enctype=multipart/form-data action=processor.php onSubmit="return validatePage1();"><ul class=mainForm id="mainForm_1">
				...
				<li class="mainForm" id="fieldBox_4">
					<label class="formFieldQuestion">Venue Category&nbsp;*&nbsp;<a class=info href=#><img src=imgs/tip_small.png border=0><span class=infobox>Restaurant, Bar & Restaurant, Lounge etc.</span></a></label><select name=field_4 id=field_4><option value=''></option><option value="Restaurant">Restaurant</option><option value="Restaurant & Bar">Restaurant & Bar</option><option value="Bar">Bar</option><option value="Lounge">Lounge</option><option value="Nightclub"></option></select></li>
                    
                    <li class="mainForm" id="fieldBox_7">
					<label class="formFieldQuestion">Cuisine&nbsp;<a class=info href=#><img src=imgs/tip_small.png border=0><span class=infobox>Type of cuisine served if applicable</span></a></label><input class=mainForm type=text name=field_7 id=field_7 size='20' value=''></li>

				<li class="mainForm" id="fieldBox_5">
					<label class="formFieldQuestion">Description&nbsp;*&nbsp;<a class=info href=#><img src=imgs/tip_small.png border=0><span class=infobox>Description of your establishment be sure to include type of cuisine,  atmosphere, crowd and geography.</span></a></label><input class=mainForm type=text name=field_5 id=field_5 size='80' value=''></li>
                    
                  <li class="mainForm" id="fieldBox_8">
					<label class="formFieldQuestion">Outdoor Seating&nbsp;<a class=info href=#><img src=imgs/tip_small.png border=0><span class=infobox>True or False</span></a></label><select name=field_8 id=field_8><option value="True">True</option><option value="False">False</option></select></li>

				
					
<input type="hidden" name="subaddrest" value="1">
...
Sunday<input type="hidden" name="days[7]" value="NULL"><input type="checkbox" name="days[7]" value="Sunday"><br>
